...
@section('content')
    <div class="container">
        <h1><p><strong>POLÍTICA DE PRIVACIDAD</strong></p></h1>
        <p>La presente Política de Privacidad establece los términos en que SocialSistemas usa y protege la información que
        ...
        <p>Nuestro sitio web podrá recoger información personal por ejemplo: Nombre,&nbsp; información de contacto
            como&nbsp; su dirección de correo electrónica. Así mismo cuando sea necesario podrá
        ...
        <p>SocialSistemas está altamente comprometido para cumplir con el compromiso de mantener su información segura.
        ...
        <p>En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es
            proporcionada a nuestro sitio web.</p>
        ...
        <p>SocialSistemas Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
            momento.</p>
    </div>
@endsection
